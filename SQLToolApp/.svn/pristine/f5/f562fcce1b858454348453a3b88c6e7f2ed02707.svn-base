...
select 'using System;' + char(13) +
		...
		(STUFF((SELECT char(9) + char(9) + 'protected ' + 
			CASE WHEN ColumnType in('float','double','decimal')
				...
				WHEN ColumnType = 'bit'
					then 'bool'
				WHEN ColumnType in('image','varbinary','binary','')
					then 'byte[]'
				ELSE 'String'
			END + ' ' + ColName + 
		...
		(STUFF((SELECT char(9) + char(9) + 'public ' + 
			CASE WHEN ColumnType in('float','double','decimal')
					Then 'double'
				WHEN ColumnType in('datetime','datetime2','date','time','time2','datetimeoffset')
					then case when ColumnIsNull = 0 then 'DateTime' else 'Nullable<DateTime>' end
			...
			char(9) + char(9) + '{' + char(13) +
			char(9) + char(9) + char(9) + 'get { return ' + ColName + '; }' + char(13) +
			char(9) + char(9) + char(9) + 'set' + char(13) +
			char(9) + char(9) + char(9) + '{' + char(13) +
			char(9) + char(9) + char(9) + char(9) + 'if (value != this.' + ColName + ')' + char(13) +
			char(9) + char(9) + char(9) + char(9) + '{' + char(13) +
			char(9) + char(9) + char(9) + char(9) + char(9) + ColName + ' = value;' + char(13) +
			char(9) + char(9) + char(9) + char(9) + char(9) + 'NotifyChanged("' + ColumnName + '");' + char(13) +
			char(9) + char(9) + char(9) + char(9) + '}' + char(13) +
			char(9) + char(9) + char(9) + '}' + char(13) +
			char(9) + char(9) + '}' + char(13)
		FROM #systable_columns FOR XML PATH(''), TYPE).value('.', 'NVARCHAR(MAX)'), 1, 0, '')) +
